...
grass_img = pygame.image.load(r'.\Assets\tiles\grass.png')
dirt_img = pygame.image.load(r'.\Assets\tiles\dirt.png')

player_img = pygame.image.load(r'.\Assets\tiles\player.png').convert()
